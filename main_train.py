...
def redq_exp(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
    ...
    # test_env.viewer.window.set_visible(False)
    # bias_eval_env.viewer.window.set_visible(False)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='The python code to train a agent using redq')
    parser.add_argument('--env', type=str, default='Hopper-v2',
                        help='The env to train the agent')
    parser.add_argument('--seed', '-s', type=int, default=0,
                        help='The seed to initialize some parameters')
    parser.add_argument('--epochs', type=int, default=-1,
                        help='The epochs to train')  # -1 means use mbpo epochs
    parser.add_argument('--exp_name', type=str, default='redq_sac',
                        help='The exp name used to store the train data')
    ...
    exp_full_name = args.exp_name + '_%s' % args.env
    ...
    # for none seed, the progress.txt will be saved under data_dir/exp_name
